<template>
  <div class="mx-auto max-w-screen-2xl prose dark:prose-invert">
    ...
    <ul>
            <li>
                <p><strong>Application</strong> refers to Club Hub, the software program provided by the Company.
                </p>
            </li>
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Club Hub.</p>
            </li>
            <li>
        ...
        <p>The Service stores personal data, including name, school, and interests.</p>
        <h3>Use of Your Personal Data</h3>
        <p>The Company does not use your Personal Data for any purpose outside of the function of the Application.</p>
        <h3>Transfer of Your Personal Data</h3>
        <p>Your information, including Personal Data, is stored on the Device and is never shared.</p>
        <h3>Delete Your Personal Data</h3>
        <p>You may delete any Personal Data from the Application at any time.</p>
        ...
        <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any
            third party sites or service.</p>
