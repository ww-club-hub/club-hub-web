...
const electionsRoutes = [
  "club-elections",
  "club-elections-apply",
  "club-elections-vote",
  "club-elections-settings"
];
    ...
    <div class="bg-gray-200 dark:bg-gray-800">
      <div class="mx-auto max-w-screen-2xl p-3 pb-0">
        ...
        <div class="mb-3 flex items-center gap-3">
          <img class="w-6 h-6" alt="Club icon" :src="club.logoUrl" />
          <h1 class="text-3xl text-black dark:text-white font-bold mb-2">{{ club.name }}</h1>
        </div>
        <!-- tab bar -->
        <div class="border-b border-gray-200 dark:border-gray-700">
          <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
            <ClubTabLink :active="route.name === 'club-dashboard'" name="Overview" :to="{ name: 'club-dashboard', params: { clubId} }">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
                <path d="M11.47 3.841a.75.75 0 0 1 1.06 0l8.69 8.69a.75.75 0 1 0 1.06-1.061l-8.689-8.69a2.25 2.25 0 0 0-3.182 0l-8.69 8.69a.75.75 0 1 0 1.061 1.06l8.69-8.689Z" />
  <path d="m12 5.432 8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 0 1-.75-.75v-4.5a.75.75 0 0 0-.75-.75h-3a.75.75 0 0 0-.75.75V21a.75.75 0 0 1-.75.75H5.625a1.875 1.875 0 0 1-1.875-1.875v-6.198a2.29 2.29 0 0 0 .091-.086L12 5.432Z" />
              </svg>
            </ClubTabLink>
            <ClubTabLink :active="route.name === 'club-meetings'" name="Meetings & Attendance" :to="{ name: 'club-meetings', params: { clubId } }">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
            ...
            <ClubTabLink :active="route.name === 'club-forms'" name="Forms" :to="{ name: 'club-forms', params: { clubId} }">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4"><path d="m3 17 2 2 4-4"/><path d="m3 7 2 2 4-4"/><path d="M13 6h8"/><path d="M13 12h8"/><path d="M13 18h8"/></svg>
            </ClubTabLink>
            <ClubTabLink
              v-if="role.member || role.officer || role.stuco"
              :active="electionsRoutes.includes(String(route.name))"
              name="Elections"
              :to="{ name: 'club-elections', params: { clubId} }"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4"><path d="M15 5.88 14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h2.76a2 2 0 0 0 1.79-1.11L12 2a3.13 3.13 0 0 1 3 3.88Z"/><path d="M7 10v12"/></svg>
            </ClubTabLink>

            <!-- officer-only links -->
            <template v-if="role.officer || role.stuco">
              <ClubTabLink :active="route.name === 'club-permission'" class="ms-auto" name="Officers" :to="{ name: 'club-permission', params: { clubId} }">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
                  <path d="M11.47 3.841a.75.75 0 0 1 1.06 0l8.69 8.69a.75.75 0 1 0 1.06-1.061l-8.689-8.69a2.25 2.25 0 0 0-3.182 0l-8.69 8.69a.75.75 0 1 0 1.061 1.06l8.69-8.689Z" />
                  <path d="m12 5.432 8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 0 1-.75-.75v-4.5a.75.75 0 0 0-.75-.75h-3a.75.75 0 0 0-.75.75V21a.75.75 0 0 1-.75.75H5.625a1.875 1.875 0 0 1-1.875-1.875v-6.198a2.29 2.29 0 0 0 .091-.086L12 5.432Z" />
                </svg>
              ...
              <ClubTabLink
                v-if="(role.officer & OfficerPermission.Members) > 0"
                :active="route.name === 'club-members'"
                name="Members"
                :to="{ name: 'club-members', params: { clubId} }"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
              ...
              <ClubTabLink
                v-if="(role.officer & OfficerPermission.ClubDetails) > 0"
                :active="route.name === 'club-settings'"
                name="Settings"
                :to="{ name: 'club-settings', params: { clubId} }"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
