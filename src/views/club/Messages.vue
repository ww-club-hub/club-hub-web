...
<template>
  ...
  <div v-if="updates.length > 0" class="flex gap-3 flex-row flex-wrap md:block md:columns-3">
    <div v-for="update in updates" :key="update.id" class="max-w-sm py-4 px-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
